...
const val CONF_PATH = "src/main/kotlin/conf/config.yml"
const val RESULT_CONF_PATH = "src/main/kotlin/result/config.json"
const val RESULT_DATA_PATH = "src/main/kotlin/result/data.json"
